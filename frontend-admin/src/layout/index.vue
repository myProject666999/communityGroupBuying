    ...
    <el-aside :width="isCollapse ? '64px' : '200px'" class="aside">
      ...
      >
        ...
        <el-sub-menu index="product">
          ...
          <el-menu-item index="/product">农产品管理</el-menu-item>
        ...
        <el-sub-menu index="content">
          ...
          <el-menu-item index="/promotion">优惠促销</el-menu-item>
          <el-menu-item index="/knowledge">农产品知识</el-menu-item>
